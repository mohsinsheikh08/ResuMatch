 ...
 return (
    <div className='bg-[#1c1c1c] w-full flex justify-center items-center  h-screen'>
        <div className=' h-[90%] mx-10 w-100 px-4  flex justify-center  flex-col   py-3 '>
         ...
         <LoginPage />
       <Link href='/register'> <p className="text-white text-sm flex justify-center gap-1">If you do not have account! <span className="text-[#FF7F00] underline cursor-pointer">Register</span></p></Link>
        </div>  
    </div>
  )
}
