...
const RegisterRouter = () => {
  return (
    <div className='bg-[#1c1c1c] w-full flex  justify-center items-center h-screen'>
       ...
       <Link href='/login'> <p className="text-white  text-sm flex justify-center gap-1">If you have already account! <span className="text-[#FF7F00] underline cursor-pointer">Login</span></p></Link>
        </div>  
    </div>
  )
}
